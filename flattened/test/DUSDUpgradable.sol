...
// File contracts/src/DUSDUpgradable.sol

pragma solidity ^0.8.0;

/**
 * @title Upgradable DUSD smart contract for Fisco BCOS
 * @author MetaBank SG
 * @notice This is the official smart contract for DUSD ERC20 Tokens on Fisco
