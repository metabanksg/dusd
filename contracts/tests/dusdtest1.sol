...
contract dusdtest1 is ERC20, Ownable, Pausable, ERC20Permit {
    ...
    constructor(uint256 _initialSupply, address[] memory _owners, uint256 _numConfirmationsRequired, uint256 _signatureAmount) ERC20("DUSDTEST", "DUSDTEST") 
    ERC20Permit("dusdtest1") {
    ...
    function mint(address _to, uint256 _amount) external onlyPrimaryOwner whenNotPaused {
        _mint(_to, _amount);
    ...
    function burn(address _from, uint256 _amount) external onlyPrimaryOwner whenNotPaused {
        _burn(_from, _amount);
