...
contract DUSDFiscoCompatibleFlattenUpdate is ERC20, Ownable, Pausable, ERC20Permit {
    ...
    constructor(uint256 _initialSupply, address _multiSigWallet) ERC20("DUSD", "DUSD") 
    ERC20Permit("DUSDFiscoCompatibleFlattenUpdate") {
    ...
    function burn(address _from, uint256 _amount) external onlyOwner whenNotPaused {
        ...
        emit BalanceUpdated(_from, balanceOf(_from));
    }
